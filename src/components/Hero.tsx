  ...
  return (
    <section className="w-full h-[100vh] relative overflow-hidden bg-white">
      ...
      <div className="w-full max-w-4xl absolute -translate-x-2/4 -translate-y-2/4 text-center mx-auto my-0 px-5 py-0 left-2/4 top-2/4">
        <div className="inline-flex justify-center items-center gap-2 bg-[#4A80DE] mb-5 px-4 py-2 rounded-full">
        ...
        <div className="flex justify-center gap-8 flex-wrap flex-row mt-[60px] max-md:flex-col max-md:items-center max-sm:flex-col max-sm:gap-5">
          <div className="flex items-center gap-3">
            <div className="flex w-10 h-10 justify-center items-center bg-[rgba(74,128,222,0.20)] p-2.5 rounded-full">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18.3333 4.16669H15" stroke="white" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M3.33301 14.1667V15.8334" stroke="white" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
          ...
          <div className="flex items-center gap-3">
            <div className="flex w-10 h-10 justify-center items-center bg-[rgba(74,128,222,0.20)] p-2.5 rounded-full">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10 5V10L13.3333 11.6667" stroke="white" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              ...
              <a href='#' className="text-white text-xs font-poppins font-normal leading-4 underline cursor-pointer hover:text-black">
                Entrega rápida *[1]
              </a>
            </div>
          </div>
