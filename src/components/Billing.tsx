      ...
      <div className="max-w-[1200px] mx-auto my-0">
        <div className="text-center mb-[60px]">
          <div className="inline-flex justify-center items-center bg-[rgba(74,128,222,0.10)] mb-5 px-5 py-2 rounded-full">
            <span className="text-[#4A80DE] text-center text-sm font-semibold leading-5">
              Facturación
            </span>
          </div>
          <h2 className="text-black text-center text-[40px] font-bold leading-9 tracking-[-1px] mb-5">
            Solicita tu factura fácilmente
          </h2>
          <p className="text-[#003A9E] text-center text-lg font-normal leading-[29px] mb-[60px]">
            Genera tu factura de manera rápida y sin complicaciones. Solo
            necesitas tu ticket de compra.
          </p>
        </div>
        
        <div className="max-w-[800px] shadow-[0_4px_20px_0_rgba(0,0,255,0.08)] mx-auto my-0 px-10 py-11 rounded-[20px] border-2 border-solid border-[rgba(0,0,255,0.10)] bg-white">
          <div className="text-center mb-10">
            <div className="inline-flex w-28 h-28 justify-center items-center bg-[rgba(0,0,255,0.10)] mb-5 p-6 rounded-2xl">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M40.0003 5.3335H16.0003C14.5858 5.3335 13.2293 5.8954 12.2291 6.89559C11.2289 7.89579 10.667 9.25234 10.667 10.6668V53.3335C10.667 54.748 11.2289 56.1045 12.2291 57.1047C13.2293 58.1049 14.5858 58.6668 16.0003 58.6668H48.0003C49.4148 58.6668 50.7714 58.1049 51.7716 57.1047C52.7718 56.1045 53.3337 54.748 53.3337 53.3335V18.6668L40.0003 5.3335Z" stroke="#0000FF" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M37.333 5.3335V16.0002C37.333 17.4147 37.8949 18.7712 38.8951 19.7714C39.8953 20.7716 41.2519 21.3335 42.6663 21.3335H53.333" stroke="#0000FF" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M26.6663 24H21.333" stroke="#0000FF" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M42.6663 34.6665H21.333" stroke="#0000FF" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M42.6663 45.3335H21.333" stroke="#0000FF" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <h3 className="text-black text-center text-lg font-semibold leading-7 tracking-[-0.45px]">
          ...
          <div className="flex items-center gap-[18px] bg-[rgba(74,128,222,0.08)] mb-10 px-4 py-3 rounded-xl border-l-4 border-l-[#4A80DE] border-solid">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M10 13.3333V10" stroke="#4A80DE" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M10 6.6665H10.0083" stroke="#4A80DE" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <p className="text-[#003A9E] text-sm font-normal leading-[23px]">
              Tienes hasta <span className="font-medium">3 días hábiles</span> después de tu compra para solicitar tu factura. Si tu compra fue realizada en los <span className="font-semibold">últimos días del mes</span>, la solicitud deberá hacerse <span className="font-medium">antes</span> de que finalice el mes.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="cfdiUse" className="block text-sm font-medium text-gray-700 mb-2">
                  Uso de CFDI
                </label>
                <select
                  id="cfdiUse"
            ...
            <div>
              <label htmlFor="fiscalDocument" className="block text-sm font-medium text-gray-700 mb-2">
